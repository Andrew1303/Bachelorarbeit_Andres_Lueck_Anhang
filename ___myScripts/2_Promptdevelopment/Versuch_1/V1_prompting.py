...
# ---------------------------------------- GET PROMPTS -----------------------------------------------------------
with open("___Scripts-relevant\\Promptdevelopment\\Prompts.json") as jsondata:
...
for index, prompt in enumerate(prompts):
    defined_prompt = prompt.replace("[itemname]", partname)
    itemprompts.append(defined_prompt)
