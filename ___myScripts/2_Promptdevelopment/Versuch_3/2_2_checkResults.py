...
# Path to files
pathresults = ["___myScripts", "2_Promptdevelopment", "Versuch_3", "results"]
...
#     #OUTER
#     outer_wedges, _ = ax.pie(sizes, radius=1,
...
#     # INNER
#     inner_wedges, _ = ax.pie([contextsuccess["good"], contextsuccess["bad"]], radius=1-size,
#     wedgeprops=dict(width=size, edgecolor='w'),
#     colors=innercolors)
...
#     savepathparts = ["___myScripts", "2_Promptdevelopment", "Versuch_3", "checkresultsplots", f"V1_{p+1}_{i}.png"]
