...
def multipieplot(context_data_list:list, bfr_data_list:list, title_list:list, name:str):
    ...
    # fig.legend(['IR ≥ 50%', '0 < IR < 0.5', 'IR = 0'], loc="upper right", title="Categories", bbox_to_anchor=(0.97, 0.97))
    plt.tight_layout(rect=[0, 0, 0.85, 1], pad=2)
    # plt.show()

    savepathparts = ["___myScripts", "2_Promptdevelopment", "Versuch_5", "checkresultmultiplots", name + ".png"]
